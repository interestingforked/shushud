module ResourceOwnershipService
  ...
  def activate(provider_id, account_id, resource_id, time, entity_id)
    [200, create_record(provider_id, account_id, resource_id, ResourceOwnershipRecord::ACTIVE, time, entity_id)]
  end

  def deactivate(provider_id, account_id, resource_id, time, entity_id)
    [200, create_record(provider_id, account_id, resource_id, ResourceOwnershipRecord::INACTIVE, time, entity_id)]
  end
